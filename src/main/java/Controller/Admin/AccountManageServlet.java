 ...
 * @author ACER
 */
@WebServlet(name = "AccountManageServlet", urlPatterns = {"/AccountManageServlet"})
public class AccountManageServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // Lấy danh sách tài khoản không bị block
        List<User> Accounts = dao.getListAccount();

        // Đưa danh sách vào request scope
        request.setAttribute("Accounts", Accounts);

        // Forward sang JSP để hiển thị
        request.getRequestDispatcher("/JSP/Admin/accountManager.jsp").forward(request, response);
    }
