...
public class CreateAccountServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userCreater) {
            ...
            boolean accountCreated = dao.createAccount(accId, password, email, user_id);
            if (accountCreated) {
                response.sendRedirect("AccountManageServlet?msg=created");
            } else {
                response.sendRedirect("AccountManageServlet?msg=create_acc_fail");
            }
        } else {
            response.sendRedirect("AccountManageServlet?msg=create_user_fail");
        }
    }
