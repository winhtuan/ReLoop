 ...
 * @author ACER
 */
@WebServlet(name = "BlockListAccountServlet", urlPatterns = {"/BlockListAccountServlet"})
public class BlockListAccountServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // Lấy danh sách tài khoản bị block
        List<User> blockAccounts = dao.getListBlockedAccount();
