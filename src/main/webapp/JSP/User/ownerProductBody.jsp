...
<head>
  ...
  <style>
    ...
    ::-webkit-scrollbar-track { background-color: rgba(254, 252, 232, 0.5); }
    .gradient-bg {
...
<div class="bg-white rounded-xl shadow-md p-6 mb-8">
  <div class="flex flex-col md:flex-row items-center gap-6">
    ...
    <div class="flex-1 md:text-left">
      ...
      <a href="createProduct.jsp" class="inline-flex items-center gap-2 px-4 py-2 bg-yellow-400 text-white rounded hover:bg-yellow-500 font-semibold">
