    ...
    <body>
        ...
        <main class="flex-1">
            <div class="header bg-white flex items-center px-6 py-4 gap-3 pb-[100px]">
                <span class="material-symbols-rounded text-gray-600 text-3xl">thumb_up</span>
                <h1 class="text-2xl font-semibold text-gray-800">Approve Post</h1>
            </div>
                                ...
                                <tr class="border-b">
                                    ...
                                    <td class="px-4 py-2 text-right pr-[110px]">
                                        <div class="flex justify-end items-center gap-4">
                                            <button type="button" class="group relative cursor-pointer text-yellow-600 hover:text-yellow-800">
