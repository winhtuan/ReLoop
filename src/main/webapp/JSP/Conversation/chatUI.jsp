        ...
        ws.onmessage = function (event) {
            ...
            if (msg.type === "block_status") {
                ...
                if (msg.status === "blocked_by_me" || msg.status === "blocked_me") {
                    ...
                    if (msg.status === "blocked_by_me") unblockBtn.style.display = "inline-block";
                    else unblockBtn.style.display = "none";
            ...
            if (isRelated) addMessageToChatBox(msg);
            ...
            if (!isSentByMe && msg.fromUserId !== currentChatUserId) markUserAsUnread(msg.fromUserId);
            else markMessagesAsRead(msg.fromUserId);
        };
    </script>
